...
void Graphics_DebugPoint(const SVector2& vPosition, unsigned int rgb = 0xFFFFFF);
...
void Shader_SetVectorArray(const char* pName, const D3DXVECTOR4* bValues, int iCount);
